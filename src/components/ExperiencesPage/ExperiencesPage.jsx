...
const ExperiencesPage = () => {
  ...
  return (
    <>
      ...
      {conutries.map((country, index) => (
        <CountryComponent
          // eslint-disable-next-line react/no-array-index-key
          key={index}
          backgorund={country.backgorund}
          image={country.image}
      ...
      <div className={styles.itinerary}>
        ...
        <div className={styles.itinerary__section}>
          {itineraries.map((itinirary, index) => (
            <Itinerary
              // eslint-disable-next-line react/no-array-index-key
              key={index}
              number={itinirary.number}
              image={itinirary.image}
              heading={itinirary.heading}
              t1={itinirary.t1}
              t2={itinirary.t2}
              t3={itinirary.t3}
              t4={itinirary.t4}
